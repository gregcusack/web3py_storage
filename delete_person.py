...
if len(sys.argv) < 2:
    print("please enter name to delete from people map")
    sys.exit(-1)
...
transaction = storage.functions.removePersonFromMap(inName).buildTransaction({
...
print('deleting person from People Map in contract...')
...
print("person with name: " + inName + " deleted")